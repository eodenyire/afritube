        ...
        >
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="shrink-0 w-7 h-7 flex items-center justify-center rounded-full hover:bg-secondary text-muted-foreground hover:text-foreground transition-colors mt-0.5"
            >
